...
//////////////////////////////////////////////////////////////////////////
class IsThisGreaterThanSRV: public RosServiceNode<tutorials_btros::IsThisGreaterThan>
{
  public:
    IsThisGreaterThanSRV( ros::NodeHandle& handle, const std::string& node_name, const NodeConfiguration & conf):
    RosServiceNode<tutorials_btros::IsThisGreaterThan>(handle, node_name, conf) {}
